...
const ParticipatedRoomList = () => {
  const { data: participatedRoomList, isPending } = useFetchParticipatedRoomList();

  return (
    <ContentSection title="">
      {participatedRoomList ? (
        <RoomList roomList={participatedRoomList.rooms} isPending={isPending} participated={true} />
      ) : (
