    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <S.RoomCardModalContainer>
        ...
        <S.EtcContainer>
          ...
          <S.InfoRow>
            <S.InfoTitle aria-hidden>미션 참여 인원</S.InfoTitle>
            <S.InfoContent aria-hidden>
              {roomInfo.currentParticipants}명 / {roomInfo.limitedParticipants}명
            </S.InfoContent>
            <S.ScreenReader>{`미션 참여 인원 최대 ${roomInfo.limitedParticipants}명 현재 ${roomInfo.currentParticipants}명 `}</S.ScreenReader>
          </S.InfoRow>
        </S.EtcContainer>
