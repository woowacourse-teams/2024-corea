...
class ReceivedFeedbacksTest {
    ...
    void findTopFeedbackKeywords1() {
        List<List<FeedbackKeyword>> reviewerFeedbacks = List.of(
        ...
        List<List<FeedbackKeyword>> revieweeFeedbacks = List.of(
        ...
        assertThat(result).containsExactly("친절했어요.", "도움이 되었어요.", "리뷰가 빨랐어요.");
    }
