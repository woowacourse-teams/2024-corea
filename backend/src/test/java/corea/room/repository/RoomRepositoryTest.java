...
class RoomRepositoryTest {
    ...
    void findAllByMemberAndClassificationAndStatus(Classification classification, int expectedSize) {
        Page<Room> rooms = roomRepository.findAllByMemberAndClassificationAndStatus(1, classification, RoomStatus.OPENED, PageRequest.of(0, 4));
    ...
    void findAllByMemberAndStatus() {
        Page<Room> roomsWithPage = roomRepository.findAllByMemberAndStatus(1, RoomStatus.OPENED, PageRequest.of(0, 4));
