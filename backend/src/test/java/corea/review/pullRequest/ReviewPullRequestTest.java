...
class ReviewPullRequestTest {
    ...
    void test() {
        ...
        participationService.participate(new ParticipationRequest(room.getId(), manager.getId(), "both", 3));
        participationService.participate(new ParticipationRequest(room.getId(), reviewer.getId(), "both", 3));
        participationService.participate(new ParticipationRequest(room.getId(), reviewee.getId(), "both", 3));
        participationService.participate(new ParticipationRequest(room.getId(), participant.getId(), "both", 3));
