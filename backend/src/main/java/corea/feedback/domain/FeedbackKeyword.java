...
public enum FeedbackKeyword {
    ...
    VERY_GOOD_AT_EXPLAINING("설명이 이해가 매우 잘 되었어요.", Satisfaction.VERY_SATISFIED, KeywordType.REVIEWER_FEEDBACK_KEYWORD),
    VERY_HELPFUL("많은 도움이 되었어요.", Satisfaction.VERY_SATISFIED, KeywordType.REVIEWER_FEEDBACK_KEYWORD),
    VERY_REVIEW_WAS_FAST("리뷰가 매우 빨랐어요.", Satisfaction.VERY_SATISFIED, KeywordType.REVIEWER_FEEDBACK_KEYWORD),
