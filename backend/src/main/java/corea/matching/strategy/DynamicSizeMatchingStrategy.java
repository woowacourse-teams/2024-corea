...
public class DynamicSizeMatchingStrategy implements MatchingStrategy {
    ...
    public List<Pair> matchPairs(List<Participation> participations, int roomMatchingSize) {
        ...
        validateSize(roomMatchingSize, participationWithoutReviewer);
    ...
    private void validateSize(int roomMatchingSize, List<Participation> participationWithoutReviewer) {
        if (participationWithoutReviewer.size() <= roomMatchingSize) {
